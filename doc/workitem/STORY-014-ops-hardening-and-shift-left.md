...
- **CI quality gates**: `detailed-implementation-plan.md` §8 — 8 PR merge gates: lint, type check, unit tests, contract schema tests, migration smoke, MCP contract tests, determinism replay, security scan; all must pass before merge
...
- [ ] All 8 PR merge gates documented in `detailed-implementation-plan.md` §8 are enforced
- [ ] `TC-S12-001` through `TC-S12-004` pass in appropriate profiles
